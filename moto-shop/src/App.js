    ...
    <div className="App">
      ...
      <footer className="footer" id="contact">
          ...
          <div className="footer-contact">
            ...
            <div className="contact-list">
              ...
              >
                ...
                <span>(21) 97337-3098</span>
              </a>
              <a
                className="contact-item"
                href="https://instagram.com/startcria021"
                target="_blank"
                rel="noreferrer"
              >
                <span className="contact-icon" aria-hidden="true">
                ...
                <span>@startcria021</span>
              </a>
              <a
                className="contact-item"
                href="https://www.tiktok.com/@startcria021"
                target="_blank"
                rel="noreferrer"
              >
                <span className="contact-icon" aria-hidden="true">
              ...
              <a
                className="contact-item"
                href="https://facebook.com/startcria021"
                target="_blank"
                rel="noreferrer"
              >
                <span className="contact-icon" aria-hidden="true">
              ...
              <a className="contact-item" href="mailto:startcria021@google.com">
                <span className="contact-icon" aria-hidden="true">
                  <svg viewBox="0 0 32 32" role="img" focusable="false">
                ...
                <span>startcria021@google.com</span>
              </a>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <span>&copy; 2026 StartCria021. Todos os direitos reservados.</span>
